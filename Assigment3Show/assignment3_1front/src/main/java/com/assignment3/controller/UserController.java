...
public class UserController {
    ...
    /////////////////////comentari///////////////////////
    @RequestMapping(value = "/comentari", method = RequestMethod.GET)
    public String showComentaris(Model model) {
        ...
        model.addAttribute("comentaris", users);
        return "viewComentari";
    }

    @RequestMapping(value = "/addComentari", method = RequestMethod.GET)
    public String showAddComentari(Model model) {
        return "addComentari";
    }

    @RequestMapping(value = "/addComentari", method = RequestMethod.POST)
    public String addComentari(@ModelAttribute("Comentariu") Comentari user) {
        ...
        return "redirect:comentari";
    }

    @RequestMapping(value = "/deleteComentari/{userId}", method = RequestMethod.POST)
    ...
    @RequestMapping(value = "/userfilms", method = RequestMethod.GET)
    public String showFilmsUser(Model model) {
        ...
        model.addAttribute("userfilms", users);
        return "viewFilmsUser";
    }
    ...
    @RequestMapping(value = "/usertipfilms", method = RequestMethod.GET)
    public String showtipFilmsUser(Model model) {
        ...
        model.addAttribute("usertipfilms", users);
        return "viewTipFilmsUser";
    }
}
