...
<div class="topnav">
    ...
    <a class="active"   href="/shows-1/addSubscribe">Add Subscribe</a>
    <a href="/shows-1/subscribe">View Subs</a>
    <a href="/shows-1/login">Log out</a>
</div>
<div class="form">
    <form method="post" action="/shows-1/addSubscribe">
    	<p>
            iduser: <br>
        ...
        <p>
            idfilmtip: <br>
            <input type="text" id="idfilmtip" name="idfilmtip" required/>
        </p>
        <p>
            <input type="submit" name="addSubscribe" value="Add Subscribe">
        </p>
    </form>
</div>
</body>
