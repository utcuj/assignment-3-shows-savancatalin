...
<table id="clients">
    ...
    <div class="topnav">
        <a href="/pharmacy-1/employee">Home</a>
        <a class="active" href="/pharmacy-1/employeeViewMedications">View Medications</a>
    ...
    <c:forEach items="${medications}" var="medication">
        <tr id="data">
            ...
            <td>
                <table>
                    <tr>
                        <form action="/pharmacy-1/employeeSellMedication/${medication.ID}" method="post">
